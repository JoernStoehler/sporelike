...
export function EvolveView({ era, onAdvanceEra }: Props) {
    ...
    <div className="view evolve-view">
      ...
      {preview && !accepted && (
        <div className="preview-section">
          ...
          <SpeciesCard species={preview.species} isChanged changeLabel="MUTATED" />
      ...
      {accepted && preview && (
        <div className="accepted-section">
          ...
          <SpeciesCard species={preview.species} isChanged changeLabel="NEXT FORM" size="large" />
